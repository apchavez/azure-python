...
flowchart TD
    ...
    UC2 --> SQL[(Azure SQL)]
    UC2 -->|AppointmentConfirmed| EG[Event Grid Topic]
    EG --> SBQ[Cola Service Bus: appointment-confirmations]
    SBQ --> W2[confirmAppointment]
    W2 --> UC3[ConfirmAppointmentUseCase]
    UC3 -->|COMPLETED| Cosmos
    UC3 --> ACS[Notificación por Email ACS]
```
