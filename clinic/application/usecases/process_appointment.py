...
topic (subscription `appointment-worker`, see function_app.py). This is the consumer half of the
single publish -> consume pipeline:
...
5. record the completion in the event store and notify the insured party
